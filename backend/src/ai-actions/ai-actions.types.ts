...
export type RecommendationTargetModule =
  | 'ai_insights'
  | 'client'
  | 'site'
  | 'guard'
...
export const RECOMMENDATION_ACTION_STATUSES: RecommendationActionStatus[] = [
  'pending',
  'approved',
  'rejected',
  'executed',
...
export const RECOMMENDATION_ACTION_TYPES: RecommendationActionType[] = [
  'create_follow_up_task',
  'notify_admin',
  'flag_client_risk',
  'flag_site_risk',
