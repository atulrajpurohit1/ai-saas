...
exports.GuardsAliasController = exports.GuardsController = void 0;
...
let GuardsAliasController = class GuardsAliasController {
    guardsService;
    constructor(guardsService) {
        this.guardsService = guardsService;
    }
...
exports.GuardsAliasController = GuardsAliasController;
__decorate([
    (0, common_1.Get)(),
    __param(0, (0, get_user_decorator_1.GetUser)()),
    __param(1, (0, common_1.Query)('branch_id')),
    ...
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", void 0)
], GuardsAliasController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    __param(0, (0, get_user_decorator_1.GetUser)()),
    __param(1, (0, common_1.Param)('id')),
    ...
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", void 0)
], GuardsAliasController.prototype, "findOne", null);
__decorate([
    (0, common_1.Put)(':id'),
    (0, permissions_decorator_1.RequirePermission)('guards.manage'),
    __param(0, (0, get_user_decorator_1.GetUser)()),
    ...
    __metadata("design:paramtypes", [Object, String, update_guard_dto_1.UpdateGuardDto]),
    __metadata("design:returntype", void 0)
], GuardsAliasController.prototype, "update", null);
exports.GuardsAliasController = GuardsAliasController = __decorate([
    (0, common_1.Controller)('guards'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, permission_guard_1.PermissionGuard),
    (0, permissions_decorator_1.RequirePermission)('guards.view'),
    __metadata("design:paramtypes", [guards_service_1.GuardsService])
], GuardsAliasController);
