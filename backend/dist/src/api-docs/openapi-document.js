...
function buildOpenApiDocument() {
    return {
        ...
        info: {
            ...
            version: '6.3.0',
            description: 'V6 Phase 3 public API, webhook, and integration endpoints. Public API requests use tenant-scoped API keys sent as X-API-Key.',
        },
...
function publicOperation(permission, summary, schemaName) {
    return {
        summary,
        ...
        responses: {
            ...
            '403': {
                description: 'API key lacks required permission, is revoked, or expired',
            },
