...
export interface BusinessHealthComponent {
    key: 'revenue' | 'retention' | 'incidentRisk' | 'staffingCoverage' | 'paymentStatus' | 'contractHealth';
    label: string;
    score: number;
...
export interface ExecutiveOpportunityItem {
    ...
    name: string;
    category: 'high_value_client' | 'renewal_opportunity' | 'revenue_growth' | 'staffing_optimization';
